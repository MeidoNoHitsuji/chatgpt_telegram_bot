...
def get_chat_mode_menu(page_index: int):
    ...
    text = f"Выберите <b>режим чата</b>. Доступно ({len(config.chat_modes)} режима):"
...
async def show_balance_handle(update: Update, context: CallbackContext):
    ...
    if n_generated_images != 0:
        details_text += f"- DALL·E 2 (генерация изображения): <b>{image_generation_n_spent_dollars:.03f}$</b> / <b>{n_generated_images} сгенерированных изображений</b>\n"
